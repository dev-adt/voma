          ...
          <div style={{ animation: 'fadeIn 0.3s ease' }}>
            ...
            <div style={{ textAlign: 'center', background: 'var(--surface-0)', padding: '1.5rem', borderRadius: '12px', border: '1px solid var(--border)' }}>
              ...
              <img 
                ...
                alt="Homepage" 
                style={{ width: '100%', maxWidth: '650px', borderRadius: '8px', border: '1px solid var(--border)', cursor: 'zoom-in', transition: 'transform 0.2s' }}
          ...
          <div style={{ animation: 'fadeIn 0.3s ease' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
              <div style={{ borderBottom: '1px solid var(--border)', paddingBottom: '1.5rem' }}>
                <h3 style={{ fontSize: '14.5px', fontWeight: 600, color: 'var(--primary)', marginBottom: '8px', display: 'flex', alignItems: 'center', gap: '6px' }}>
                ...
                <div style={{ marginTop: '1.25rem', textAlign: 'center' }}>
                  <img 
                    ...
                    alt="Step 1" 
                    style={{ width: '100%', maxWidth: '600px', borderRadius: '8px', border: '1px solid var(--border)', cursor: 'zoom-in' }}
        ...
        return (
          <div style={{ animation: 'fadeIn 0.3s ease' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '2.5rem' }}>
              <div>
                <h3 style={{ fontSize: '14.5px', fontWeight: 600, color: 'var(--primary)', marginBottom: '1.25rem', display: 'flex', alignItems: 'center', gap: '6px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.5rem' }}>
                  <div style={{ background: 'var(--surface-0)', padding: '1rem', borderRadius: '12px', border: '1px solid var(--border)', textAlign: 'center' }}>
                    ...
                    <img 
                      ...
                      alt="Feeds" 
                      style={{ width: '100%', borderRadius: '8px', border: '1px solid var(--border)', cursor: 'zoom-in' }}
    ...
    <div className="public-body">
      ...
      <div className="public-container" style={{ minHeight: '85vh', paddingBottom: '4rem', paddingTop: '2.5rem' }}>
        ...
        <div className="shell-doc" style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap', alignItems: 'flex-start' }}>
          ...
          <div className="glass-card" style={{ width: '100%', maxWidth: '280px', minWidth: '220px', padding: '1rem', borderRadius: '16px', border: '1px solid var(--border)', background: '#FFFFFF', boxShadow: 'var(--shadow)' }}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
              {SECTIONS.map((sec) => {
                ...
                return (
                  ...
                  >
                    <i className={sec.icon} style={{ fontSize: '15px', color: isActive ? 'var(--primary)' : 'var(--text-muted)' }}></i>
                    <span>{secTitle}</span>
                  </button>
                );
              })}
          ...
          <div className="glass-card" style={{ flex: 1, minWidth: '320px', padding: '2.5rem', borderRadius: '16px', border: '1px solid var(--border)', background: '#FFFFFF', minHeight: '400px', boxShadow: 'var(--shadow)' }}>
            {renderContent()}
          </div>
        </div>
      </div>
